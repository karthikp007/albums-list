...
export default class App extends Component {
  ...
  render() {
    return (
      <>
        <Routes>
          <Route path='/albums-list' element={<AlbumsList albums={this.state.albums} setUpdateAlbum={this.setUpdateAlbum} deleteAlbumFromList={this.deleteAlbumFromList} />}></Route>
